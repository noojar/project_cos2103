 ...
 * @author PC
 */
public class Full_Insert extends javax.swing.JFrame {
        Node START;
//        Node NodeA = new Node();        
//        Node NodeB = new Node();
//        Node NodeC = new Node();
   ...
   public  Node SEARCH(int ITEM){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Full_Insert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Full_Insert().setVisible(true);
            }
        });
    }
