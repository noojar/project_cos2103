 ...
 * @author PC
 */
public class OueueGUIImplement extends javax.swing.JFrame {
     int size=10;  
...
public boolean QDELETE(){
 ...
 public  void showDatainQueue(){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("เพิ่มข้อมูลในคิว"));

        jLabel1.setText("ป้อนข้อมูล");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("ลบข้อมูลจากคิว"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("ข้อมูลในคิว"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OueueGUIImplement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OueueGUIImplement().setVisible(true);
            }
        });
    }
